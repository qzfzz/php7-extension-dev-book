...
PHP_ARG_ENABLE(sample4, whether to enable sample4 support,
Make sure that the comment is aligned:
[  --enable-sample4           Enable sample4 support])

if test "$PHP_SAMPLE4" != "no"; then
  PHP_NEW_EXTENSION(sample4, sample4.c sample4_http_util.c, $ext_shared,, -DZEND_ENABLE_STATIC_TSRMLS_CACHE=1)
fi
