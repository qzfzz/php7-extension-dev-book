...
php7中可以更简单的使用ZEND_INIT_MODULE_GLOBALS(soap, php_soap_init_globals, NULL)宏来实现：
...
PHP_MINIT_FUNCTION(sample4) {
    REGISTER_STRING_CONSTANT("SAMPLE4_VERSION", PHP_SAMPLE4_EXTVER, CONST_CS | CONST_PERSISTENT);
		...
		ZEND_INIT_MODULE_GLOBALS(sample4, php_sample4_globals_ctor, php_sample4_globals_dtor);
...
我们再来看下ZEND_MODULE_GLOBALS_ACCESSOR宏
