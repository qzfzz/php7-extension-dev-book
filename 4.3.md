...
编译之前如果需要了解一下php的configure脚本的各个配置，./configure --help一下即可，或者参考一下网络上的资料。当你确定了应该开启哪几个选项，选项都应该赋什么值后，便可以开始正式的编译我们的PHP了。这里假设你下载了php-7.1.0的源码，而且你将其解压到/php-7.1.0/目录下。
进入终端，通过cd命令进入/php-7.1.0/目录，执行./configure脚本，然后make,make test,比如：
<pre class="code">
cd /php-7.1.0
